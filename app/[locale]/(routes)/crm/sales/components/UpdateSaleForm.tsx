...
export function UpdateSaleForm({ initialData, setOpen }: NewTaskFormProps) {
  ...
  const onSubmit = async (data: NewAccountFormValues) => {
    ...
    try {
      ...
      await axios.put('/api/crm/sale', data);
      toast({
        title: 'Success',
  ...
  const { users, accounts, contacts, saleTypes, saleStages, campaigns } = sales;
